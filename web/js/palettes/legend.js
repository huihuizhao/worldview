...
export function palettesLegend(spec) {
  ...
  //     render();
  //   } else {
  //     palettes.loadRendered(config, layer.id).done(function() {
  //       if (!loaded) {
  //         loaded = true;
  //         render();
  //         if (spec.onLoad) {
  ...
  //   var $colorBarCase = $('<div></div>').addClass('colorbar-case');
  //   var $colorbar = $('<canvas></canvas>')
  //     .addClass('wv-palettes-colorbar')
  //     .attr('data-index', index);
  //   var $runningDataPointBar = $('<div></div>').addClass('wv-running-bar');
  //   // set fixed canvas dimensions
  //   $colorbar[0].width = 235;
  //   $colorbar[0].height = 12;
  //   $colorBarCase.append($colorbar).append($runningDataPointBar);
  //   $container.append($colorBarCase);

  //   var $runningDataPointLabel = $('<span></span>').addClass(
  //     'wv-running-label'
  //   );

  //   var $min = $('<div></div>').addClass('wv-palettes-min');
  //   var $max = $('<div></div>').addClass('wv-palettes-max');
  //   var $title = $('<div></div>').addClass('wv-palettes-title');
  ...
  //   palettes.colorbar(
  //     selector + ' ' + "[data-index='" + index + "'] canvas",
  //     legend.colors
  //   );
  // };
  ...
  //     } else {
  //       $(selector + " [data-index='" + index + "'] .wv-palettes-title").html(
  //         title
  //       );
  //     }
  //   });
  ...
  //   var legendIndex = $(this).attr('data-index');
  //   var classIndex = $(this).attr('data-class-index');
  //   $(
